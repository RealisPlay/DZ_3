package ru.gb.lessons.lesson_04;
...
public class HibernateTest {
     ...
     * В сравнении с SQL, HQL полностью объектно-ориентирован и использует понятия наследования, полиморфизма и связывания.
     */
    @Test
    void testHQL() {
    ...
    void testAddAndDelete() {
        ...
        //В отличие от select любые изменения происходят в рамках транзакции одной сессии
